...
const promptSuggestions = [
  {
    label: 'Coffee run',
    scene: 'Ordering coffee at a busy cafe before work while asking for a smaller cup size.',
  },
  {
    label: 'Job intro',
  ...
  {
    label: 'Doctor visit',
    scene: 'Explaining a mild headache and asking for advice at a clinic reception desk.',
  },
];
...
const practiceSteps = [
  ...
  {
    title: 'Get an AI dialogue',
    detail: 'The app builds a natural back-and-forth scene.',
  },
  {
...
export default function HomeScreen() {
  ...
  const [inputScene, setInputScene] = useState(scene);
  ...
  const trimmedScene = inputScene.trim();
  const readiness = useMemo(() => getSceneReadiness(trimmedScene), [trimmedScene]);
  ...
  const handleGenerate = useCallback(async () => {
    ...
    if (!apiKey) {
      setGenerationError('Add your OpenAI API key in Settings before generating a scene.');
      router.push('/settings');
      return;
    }

    if (!nextScene) {
      setGenerationError('Describe a speaking scene before generating dialogue.');
      return;
    }
    ...
    try {
      ...
      setGenerationError(
        error instanceof Error ? error.message : 'Could not generate dialogue. Please try again.'
      );
    } finally {
      setIsGenerating(false);
    }
  }, [apiKey, setGenerationError, setIsGenerating, setScene, setSegments, trimmedScene]);
      ...
      <ThemedView style={styles.page}>
        <ThemedView style={styles.heroCard}>
          ...
          <ThemedText style={styles.subtitle}>
            Turn a scene into a guided English role-play, then speak through it with a live
            teleprompter.
          </ThemedText>
        ...
        <ThemedView style={styles.panel}>
          <View style={styles.panelHeader}>
            <View style={styles.headerCopy}>
              ...
              <ThemedText style={styles.panelDescription}>
                The more specific your scene is, the more natural and useful the dialogue becomes.
              </ThemedText>
            </View>
            ...
            <ThemedView
              ...
              <ThemedText style={styles.statusPillText}>{readiness.label}</ThemedText>
            </ThemedView>
          </View>
          ...
          <TextInput
            ...
            placeholder="e.g. Ordering coffee at Starbucks before work and asking for oat milk."
          ...
          {trimmedScene ? (
            <ThemedView style={styles.previewCard}>
              ...
              <ThemedText style={styles.previewBody}>{shortenScene(trimmedScene)}</ThemedText>
              <View style={styles.previewMetaRow}>
                <ThemedText style={styles.previewMeta}>Scene saved for this session</ThemedText>
            ...
            {promptSuggestions.map((suggestion) => (
              <Pressable
                ...
                <ThemedView style={styles.suggestionChip}>
                  <ThemedText style={styles.suggestionText}>{suggestion.label}</ThemedText>
                </ThemedView>
              </Pressable>
            ))}
          </View>
        ...
        <ThemedView style={styles.panel}>
          <View style={styles.panelHeader}>
            <View style={styles.headerCopy}>
              ...
              <ThemedText style={styles.panelDescription}>
                Keep your API key in Settings, then jump into role-plays from here.
              </ThemedText>
            </View>
          ...
          <ThemedText style={styles.sessionBody}>
            {apiKey
              ...
              : 'Add your OpenAI API key once so dialogue generation is ready when inspiration hits.'}
          </ThemedText>
          ...
          <Pressable
            ...
            <ThemedView
              style={[styles.secondaryButton, settingsPressed && styles.secondaryButtonPressed]}>
        ...
        <Pressable
          ...
          <ThemedView
            ...
            <ThemedText style={styles.primaryButtonText}>
              {isGenerating ? 'Generating dialogue...' : 'Start speaking practice'}
            </ThemedText>
          </ThemedView>
        </Pressable>

        <ThemedText style={styles.footerNote}>
          Tip: mention the place, relationship, and your goal for better follow-up lines and more
          realistic speaking turns.
        </ThemedText>
      </ThemedView>
    </ScrollView>
  );
